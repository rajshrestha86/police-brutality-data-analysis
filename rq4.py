...
print("Partisan: ", partisan_and_republican)
print("deaths: ", deaths_by_city)
...
plt.figure()
sns.scatterplot(data=result, x="Partisan Segregation", y="counts")
# plt.show()
plt.savefig('rq4-scatter.png', bbox_inches='tight')
from scipy.stats import pearsonr
print("Pearsonr:", pearsonr(result["Partisan Segregation"], result["counts"]))
# %%
